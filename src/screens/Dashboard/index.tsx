...
export function Dashboard() {
    ...
    async function loadTransactions() {
        ...
        const lastTransactionsEntrie = getLastTransactionDate(transactions, 'positive');
        ...
        setHighLightData({
            entries: {
                ...
                lastTransactions: lastTransactionsEntrie === 0 ? `Não há transações` : `Última entrada dia ${lastTransactionsEntrie}`
            },
            expensives: {
                ...
                lastTransactions: lastTransactionsExpensives ? `Não há transações` : `última saída dia ${lastTransactionsExpensives}`
            },
            total: {
